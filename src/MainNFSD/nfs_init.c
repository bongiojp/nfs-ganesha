...
nfs_parameter_t nfs_param =
{
  ...
  .nfs4_pseudofs_param.hash_param.index_size = PRIME_STATE_ID;
  .nfs4_pseudofs_param.hash_param.alphabet_length = 10;
  .nfs4_pseudofs_param.hash_param.hash_func_key = nfs4_pseudo_value_hash_func;
  .nfs4_pseudofs_param.hash_param.hash_func_rbt = nfs4_pseudo_rbt_hash_func;
  .nfs4_pseudofs_param.hash_param.compare_key = compare_nfs4_pseudo_key;
  .nfs4_pseudofs_param.hash_param.key_to_str = display_pseudo_key;
  .nfs4_pseudofs_param.hash_param.val_to_str = display_pseudo_val;
  .nfs4_pseudofs_param.hash_param.ht_name = "NFS4 PseudoFS nodeid";
  .nfs4_pseudofs_param.hash_param.flags = HT_FLAG_CACHE;
  .nfs4_pseudofs_param.hash_param.ht_log_component = COMPONENT_NFS_V4_PSEUDO;
