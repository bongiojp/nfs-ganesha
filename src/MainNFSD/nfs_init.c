...
/* only NFSv4 is supported for the FSAL_PROXY */
  ...
  nfs_param.cache_layers_param.cache_param.hparam.ht_name = "Cache Inode";
  nfs_param.cache_layers_param.cache_param.hparam.flags = HT_FLAG_CACHE;
  nfs_param.cache_layers_param.cache_param.hparam.ht_log_component = COMPONENT_CACHE_INODE;
  ...
  nfs_param.cache_layers_param.cache_param.cookie_param.ht_name = "Lock Cookie";
  nfs_param.cache_layers_param.cache_param.cookie_param.flags = HT_FLAG_NONE;
  nfs_param.cache_layers_param.cache_param.cookie_param.ht_log_component = COMPONENT_STATE;
#endif
  ...
  for(i = 0; i < nfs_param.core_param.nb_worker; i++)
    {
      ...
      nfs_param.ip_stats_param.hash_param.ht_name = Str_Dup(name);
