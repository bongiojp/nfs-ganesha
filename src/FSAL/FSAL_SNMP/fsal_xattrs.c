...
static fsal_xattr_def_t xattr_list[] = {
  {"oid_text", get_oid_text, NULL, NULL, XATTR_FOR_ALL | XATTR_RO},
  {"oid_numeric", get_oid_numeric, NULL, NULL, XATTR_FOR_ALL | XATTR_RO}

};

#define XATTR_COUNT 2
    ...
    )
{
  ...
  st = SNMPFSAL_getattrs(p_objecthandle, p_context, &file_attrs);
